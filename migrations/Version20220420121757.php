 ...
 */
final class Version20220420121757 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE manager ADD hotel_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hotel_manager (hotel_id INT NOT NULL, manager_id INT NOT NULL, INDEX IDX_296E3B903243BB18 (hotel_id), INDEX IDX_296E3B90783E3463 (manager_id), PRIMARY KEY(hotel_id, manager_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE manager_hotel (manager_id INT NOT NULL, hotel_id INT NOT NULL, INDEX IDX_2A8C9EE3783E3463 (manager_id), INDEX IDX_2A8C9EE33243BB18 (hotel_id), PRIMARY KEY(manager_id, hotel_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
